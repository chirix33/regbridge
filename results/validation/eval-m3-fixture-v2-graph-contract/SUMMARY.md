...
|---|---|---:|---:|---:|---:|
| B0 | fixture validation only | 0.043 | 0.07142857142857142 | 0.970 | 0.967 |
| B1 | fixture validation only | 0.043 | 0.07142857142857142 | 0.847 | 0.867 |
| B2 | genuine deterministic experimental output | 0.217 | 0.35714285714285715 | 0.855 | 0.833 |
| RegBridge | fixture validation only | 0.000 | 0.0 | 1.000 | 1.000 |

## Vocabulary disclosure (sensitivity only; never an alternative headline)

| System | Scope | Outside / valid | Counts by predicted class | Rates by predicted class | Sensitivity-only accuracy excluding outside |
|---|---|---|---|---|---|
| B0 | held-out-test | 0/12 (0.0) | {"BREAK_LIFECYCLE_AND_RESUBMIT": 0, "DO_NOT_REUSE": 0, "REUSE_AFTER_METADATA_REPAIR": 0} | {"BREAK_LIFECYCLE_AND_RESUBMIT": 0.0, "DO_NOT_REUSE": 0.0, "REUSE_AFTER_METADATA_REPAIR": 0.0} | 1.0 |
| B0 | all-cases-secondary | 0/30 (0.0) | {"BREAK_LIFECYCLE_AND_RESUBMIT": 0, "DO_NOT_REUSE": 0, "REUSE_AFTER_METADATA_REPAIR": 0} | {"BREAK_LIFECYCLE_AND_RESUBMIT": 0.0, "DO_NOT_REUSE": 0.0, "REUSE_AFTER_METADATA_REPAIR": 0.0} | 0.9666666666666667 |
| B1 | held-out-test | 0/12 (0.0) | {"BREAK_LIFECYCLE_AND_RESUBMIT": 0, "DO_NOT_REUSE": 0, "REUSE_AFTER_METADATA_REPAIR": 0} | {"BREAK_LIFECYCLE_AND_RESUBMIT": 0.0, "DO_NOT_REUSE": 0.0, "REUSE_AFTER_METADATA_REPAIR": 0.0} | 0.9166666666666666 |
| B1 | all-cases-secondary | 0/30 (0.0) | {"BREAK_LIFECYCLE_AND_RESUBMIT": 0, "DO_NOT_REUSE": 0, "REUSE_AFTER_METADATA_REPAIR": 0} | {"BREAK_LIFECYCLE_AND_RESUBMIT": 0.0, "DO_NOT_REUSE": 0.0, "REUSE_AFTER_METADATA_REPAIR": 0.0} | 0.8666666666666667 |
| B2 | held-out-test | 0/12 (0.0) | {"BREAK_LIFECYCLE_AND_RESUBMIT": 0, "DO_NOT_REUSE": 0, "REUSE_AFTER_METADATA_REPAIR": 0} | {"BREAK_LIFECYCLE_AND_RESUBMIT": 0.0, "DO_NOT_REUSE": 0.0, "REUSE_AFTER_METADATA_REPAIR": 0.0} | 0.8333333333333334 |
| B2 | all-cases-secondary | 0/30 (0.0) | {"BREAK_LIFECYCLE_AND_RESUBMIT": 0, "DO_NOT_REUSE": 0, "REUSE_AFTER_METADATA_REPAIR": 0} | {"BREAK_LIFECYCLE_AND_RESUBMIT": 0.0, "DO_NOT_REUSE": 0.0, "REUSE_AFTER_METADATA_REPAIR": 0.0} | 0.8333333333333334 |
| RegBridge | held-out-test | 0/12 (0.0) | {"BREAK_LIFECYCLE_AND_RESUBMIT": 0, "DO_NOT_REUSE": 0, "REUSE_AFTER_METADATA_REPAIR": 0} | {"BREAK_LIFECYCLE_AND_RESUBMIT": 0.0, "DO_NOT_REUSE": 0.0, "REUSE_AFTER_METADATA_REPAIR": 0.0} | 1.0 |
| RegBridge | all-cases-secondary | 0/30 (0.0) | {"BREAK_LIFECYCLE_AND_RESUBMIT": 0, "DO_NOT_REUSE": 0, "REUSE_AFTER_METADATA_REPAIR": 0} | {"BREAK_LIFECYCLE_AND_RESUBMIT": 0.0, "DO_NOT_REUSE": 0.0, "REUSE_AFTER_METADATA_REPAIR": 0.0} | 1.0 |
